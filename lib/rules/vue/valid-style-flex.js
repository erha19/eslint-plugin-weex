...
module.exports = {
  meta: {
    docs: {
      description: 'weex does not support all properties in the flex layout',
      category: 'essential',
      url: 'https://github.com/vuejs/eslint-plugin-weex/blob/v0.0.1/docs/rules/valid-style-flex.md'
    },
    fixable: null,
    schema: []
  },
