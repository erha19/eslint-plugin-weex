...
module.exports = {
  meta: {
    docs: {
      description: 'weex `<cell>` component does not support margin-top/margin-bottom',
      category: 'essential',
      url: 'https://github.com/vuejs/eslint-plugin-weex/blob/v0.0.1/docs/rules/valid-cell-component.md'
    },
    fixable: null,
    schema: []
  },
