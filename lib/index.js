...
module.exports = {
  rules: {
    ...
    'weex/no-style-float': require('./rules/weex/no-style-float'),
    'weex/no-v-cloak': require('./rules/weex/no-v-cloak'),
    'weex/no-v-html': require('./rules/weex/no-v-html'),
    'weex/no-v-show': require('./rules/weex/no-v-show'),
    'weex/no-window': require('./rules/weex/no-window'),
    'weex/no-z-index': require('./rules/weex/no-z-index')
  },
  configs: {
