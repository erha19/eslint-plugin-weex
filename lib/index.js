...
module.exports = {
  rules: {
    ...
    'weex/no-document': require('./rules/weex/no-document'),
    'weex/no-global': require('./rules/weex/no-global'),
    'weex/no-style-display': require('./rules/weex/no-style-display'),
    'weex/no-style-float': require('./rules/weex/no-style-float'),
    'weex/no-style-z-index': require('./rules/weex/no-style-z-index'),
    ...
    'weex/valid-cell-component': require('./rules/weex/valid-cell-component'),
    'weex/valid-image-component': require('./rules/weex/valid-image-component'),
    'weex/valid-indicator-component': require('./rules/weex/valid-indicator-component'),
    'weex/valid-input-component': require('./rules/weex/valid-input-component'),
    'weex/valid-list-component': require('./rules/weex/valid-list-component'),
    'weex/valid-picker-module': require('./rules/weex/valid-picker-module'),
    'weex/valid-scroller-component': require('./rules/weex/valid-scroller-component'),
    'weex/valid-style-flex': require('./rules/weex/valid-style-flex'),
    'weex/valid-style-font-family': require('./rules/weex/valid-style-font-family'),
    'weex/valid-style-selector': require('./rules/weex/valid-style-selector'),
    'weex/valid-switch-component': require('./rules/weex/valid-switch-component'),
    'weex/valid-text-component': require('./rules/weex/valid-text-component'),
    'weex/valid-textarea-component': require('./rules/weex/valid-textarea-component'),
    'weex/valid-video-component': require('./rules/weex/valid-video-component'),
    'weex/valid-web-component': require('./rules/weex/valid-web-component')
  },
  configs: {
